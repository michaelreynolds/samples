// d3.js - generate code 39 barcode - based on code by Christpher Manning
// modified by Michael Reynolds - github.com/michaelreynolds
//function generateCode39Barcode(barcode = null, selector = null){
function generateCode39Barcode() {
    var barcode, selector;
    var barcode = d3.select("#barcode").attr("class");
    var selector = "#barcode";
    // if(barcode === null){
    // 		barcode = d3.select("#barcode").attr("class");
    // }
    // if(selector === null){
    // 		selector = "#barcode";
    // }
    var temp = barcode;
    barcode = temp.toString();
    ...
    console.log("completed generating barcode for: " + barcode);
    return true;
}
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
